...
**/
>>>>>>> cef1f1193169a98606f6b1d95abe755e8d5df280
...
<<<<<<< HEAD
    ...
    icon: 'component',
    children: [
      { path: 'list', component: _import('porduct/productList'), name: '商品信息' }
=======
    path: '/permission',
    component: Layout,
...
<<<<<<< HEAD
    ...
    icon: 'component',
    noDropdown: true,
    children: [{ path: 'list', component: _import('order/orderList'), name: '订单信息' }]
=======
    path: '/example',
    component: Layout,
...
<<<<<<< HEAD
    ...
    icon: 'excel',
    children: [
        { path: 'list', component: _import('users/userList'), name: '用户信息' }
    ]
  },
=======
